...
/**
 * _transaction_print_brief_loop - Prints a simplified representation
 * of a transaction in a loop
 *
 * @transaction: Pointer to the transaction structure to be printed
 * @idx: Index of the transaction
 * @indent: A string used to indent the print output for readability
 *
 * Return: 0 (success)
 */
