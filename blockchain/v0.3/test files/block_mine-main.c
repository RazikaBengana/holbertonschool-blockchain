...
/**
 * _add_block - Adds a new block to the blockchain with given data
 *
 * this function creates a new block with specified data, mines it,
 * and if valid, adds to blockchain
 *
