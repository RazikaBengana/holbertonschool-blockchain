...
/**
 * _add_block - Adds a new block to the blockchain
 *
 * this function simulates block mining, creates a new block with given data,
 * calculates its difficulty, sets its hash, and adds it to the blockchain
 *
 * @blockchain: Pointer to the blockchain to which the block will be added
 * @prev: Pointer to the previous block in the chain
 * @s: Data to be stored in the block
 *
