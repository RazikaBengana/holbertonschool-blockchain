...
/**
 * _print_unspent - Prints an unspent transaction output
 *
 * @unspent: Pointer to the unspent transaction output to print
 * @idx:     Index of the transaction in the list
 * @indent:  Indentation string for formatting the output
 *
 * Return: 0 (success)
 */
...
/**
 * _print_all_unspent - Prints a list of unspent transaction outputs
 *
...
/**
 * _add_block - Adds a block to a blockchain
 *
